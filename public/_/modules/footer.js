                    ...
                    <footer class="container bg-light mt-5 mb-5">
                        <div class="row">
                            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">${__html('%1$Kenzap Factory%2$ 3.0.0. ❤️ Licensed %3$GPLv3%4$.', '<a class="text-muted" href="https://events.kenzap.com/" target="_blank">', '</a>', '<a class="text-muted" href="https://github.com/kenzap/events" target="_blank">', '</a>')}</span>
