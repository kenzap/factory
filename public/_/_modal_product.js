...
export const productModal = {
    ...
    render: (_this) => {
        ...
        // coating options
        let ic = localStorage.getItem('input-coating') ? localStorage.getItem('input-coating') : (parent_list[2] ? parent_list[2] : parent_list[0]);
        ...
        _this.listeners.modalSuccessBtnFunc = (e) => {
            ...
            obj['formula_width'] = _this.state.item.formula_width;
            obj['formula_length'] = _this.state.item.formula_length;
            obj['formula_width_calc'] = _this.state.modal.querySelector(".input-price").dataset.width;
            obj['formula_length_calc'] = _this.state.modal.querySelector(".input-price").dataset.length;
