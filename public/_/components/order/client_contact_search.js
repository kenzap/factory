        ...
        document.querySelector('contact-order-search').innerHTML = `
            <div class="autocomplete-container position-relative">
                <div class="input-group input-group-sm autocomplete-container position-relative mb-2">       
                    <input type="text" class="form-control form-control-sm d-none-" id="contactPerson" placeholder="${__html('Contact person')}" autocomplete="off" value="${this.order.contactPerson || ''}" >
                </div>
