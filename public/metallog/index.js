    ...
    listeners() {
        ...
        onClick('.btn-add-worklog-record', (e) => {
            ...
            const record = {
                ...
                width: parseInt(document.querySelector('#width').value.trim()),
                length: parseInt(document.querySelector('#length').value.trim()) * 1000,
                _width: parseInt(document.querySelector('#width').value.trim()),
                _length: parseInt(document.querySelector('#length').value.trim()) * 1000,
